...
const CategoryBlockTop = () => {
    ...
    <div className={activeCategory === 'active' ? 'category_block_active' : 'category_block'}>
        <div className={activeCategory === 'active' ? 'category_block_top_title_active' : 'category_block_top_title'}>
            <h2 >Общий раздел</h2>
            <img src={activeCategory === 'active' ? IconDown : IconUp} alt="" className="icon_when" onClick={ClickFromActiveCategory}/>
        </div>
        <div className={activeCategory === 'active' ? 'category_block_top_body active': 'category_block_top_body'}>
...
export default CategoryBlockTop;
