...
import SvenImage from '../../../../assets/img/women.jpg'
    ...
    return(
        <div className="block_with_articles_home">
            <div className="topic_link_home_block">
                <h3 className="topic_link_home_block_title">Посети кальянную библиотеку</h3>
                <div className="topic_link_home_block_description">
                    ...
                    Текст генерируется абзацами случайным
                    <NavLink to="/" className="topic_link_home_block_slug">читать больше...</NavLink>
                </div>
                <div className="topic_link_home_block_info">
                    <img src={SvenImage} alt="" className="topic_link_home_block_info_image"/>
                    <div className="topic_link_home_block_info_all">
                        <div className="topic_link_home_block_info_first">
                            <div className="topic_link_home_block_info_first_name"><span>Svop</span> с Украина, Одесса</div>
